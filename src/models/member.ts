...
const memberSchema = new Schema<IMember>(
  {
    ...
    biography: {
      ...
      minlength: [2, 'длина автобиографии должна быть не менее 2 символов'],
    },
    shortBiography: {
      type: String,
      required: [true, 'не передана краткая автобиография композитора или музыковеда'],
      minlength: [2, 'длина краткой автобиографии должна быть не менее 2 символов'],
    },
    works: {
      type: String,
      required: [true, 'не передан список произведений или публикаций'],
      minlength: [2, 'длина списка произведений должна быть не менее 2 символов'],
    },
    competitions: {
      type: String,
      minlength: [2, 'длина списка конкурсов должна быть не менее 2 символов'],
    },
    awards: {
      type: String,
      minlength: [2, 'длина списка наград должна быть не менее 2 символов'],
    },
    links: {
      type: String,
      minlength: [2, 'длина списка ссылок должна быть не менее 2 символов'],
    },
  },
  { versionKey: false },
);
